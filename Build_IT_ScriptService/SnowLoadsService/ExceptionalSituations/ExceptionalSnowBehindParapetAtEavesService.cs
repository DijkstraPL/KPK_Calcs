...
namespace Build_IT_ScriptService.SnowLoadsService.ExceptionalSituations
{
    ...
    public class ExceptionalSnowBehindParapetAtEavesService : SnowLoadBaseService, ICalculator
    {
        ...
        public IResult Calculate()
        {
            ...
            result.Properties.Add("l_s_", exceptionalSnowBehindParapetAtEaves.DriftLength);
            result.Properties.Add("μ_1_", exceptionalSnowBehindParapetAtEaves.ShapeCoefficient);
            result.Properties.Add("s", exceptionalSnowBehindParapetAtEaves.SnowLoad);
