...
namespace Build_IT_ApplicationTest.AcceptanceTests.SnowLoads
{
    ...
    public class PitchedRoofTests
    {
        ...
        public void CalculateTests_RandomExamples_Success()
        {
            ...
            parametersForCalculation["α_1_"].Value = _testEngine.GetSmallRandom(max: 90);
            parametersForCalculation["α_2_"].Value = _testEngine.GetSmallRandom(max: 90);
            parametersForCalculation["SnowFencesLeftRoof"].Value = _testEngine.GetValueFromRange(
                new string[] { "true", "false" });
            parametersForCalculation["SnowFencesRightRoof"].Value = _testEngine.GetValueFromRange(
                new string[] { "true", "false" });
