...
{
    [TestFixture]
    public class SupportedNodeWithHingeTests
    {
        private SupportedNodeWithHinge _supportedNode;

        [SetUp]
        public void SetUp()
        {
            _supportedNode = new SupportedNodeWithHinge();
        }

        [Test]
        public void PropertiesTest_Success()
        {
            Assert.That(_supportedNode.DegreesOfFreedom, Is.EqualTo(2));
        ...
        public void SetDisplacementNumerationTest_Success()
        {
            ...
            Assert.That(_supportedNode.RightRotationNumber, Is.EqualTo(1));
        }
