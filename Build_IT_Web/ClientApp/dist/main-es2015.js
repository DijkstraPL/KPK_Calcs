...
let LoginComponent = class LoginComponent {
    constructor(router, fb, authService, bottomSheetRef, baseUrl) {
        this.router = router;
        this.fb = fb;
...
let NavMenuComponent = class NavMenuComponent {
    constructor(translationService, auth, configurations, searchService, router, bottomSheet) {
...
let RegisterComponent = class RegisterComponent {
    constructor(router, fb, http, baseUrl) {
        this.router = router;
        this.fb = fb;
        this.http = http;
        this.baseUrl = baseUrl;
...
let ElementSelectDirective = class ElementSelectDirective {
    constructor(el) {
        this.el = el;
        this.oldValues = '';
        ...
        this.changedSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])($(this.el.nativeElement), 'changed.bs.select').subscribe((e) => setTimeout(() => {
            if (this.checkIsValuesChanged(this.selected)) {
                this.ngModelChange.emit(this.selected);
            }
        }));
        this.shownSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])($(this.el.nativeElement), 'shown.bs.select').subscribe((e) => setTimeout(() => this.shown.emit()));
        this.hiddenSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])($(this.el.nativeElement), 'hidden.bs.select').subscribe((e) => setTimeout(() => this.hidden.emit()));
    }
    set ngModel(values) {
...
ElementSelectDirective.ctorParameters = () => [
...
let CustomViewsRoutingModule = class CustomViewsRoutingModule {
};
...
let CustomViewsModule = class CustomViewsModule {
};
...
const ScriptId = 10;
let SnowLoadMonopitchRoofComponent = class SnowLoadMonopitchRoofComponent {
    constructor(route, scriptService, parameterService, calculationService, translationService) {
        this.route = route;
    ...
    getParameters() {
        this.parameterService.getParameters(ScriptId, this.translationService.getCurrentLanguage())
            ...
            this.parameters = parameters.filter(p => (p.context & _script_interpreter_models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_6__["ParameterOptions"].editable) != 0);
        }, error => console.error(error));
    }
    onSlopeChange() {
        this.setAddition();
...
SnowLoadMonopitchRoofComponent.ctorParameters = () => [
...
let DeadLoadsCalculatorComponent = class DeadLoadsCalculatorComponent {
    constructor() {
    ...
    calculate(materialForCalculation) {
    ...
    additionChecked(materialForCalculation, addition) {
...
let DeadLoadsDataComponent = class DeadLoadsDataComponent {
    // Constructor
    constructor(deadLoadsService) {
    ...
    onCategoryChange() {
        this.deadLoadsService.getSubcategories(this.selectedCategory.id)
            ...
            this.subcategories = subcategories.sort((subcategory, nextSubcategory) => {
...
DeadLoadsDataComponent.ctorParameters = () => [
...
let DeadLoadsComponent = class DeadLoadsComponent {
    constructor() {
    }
...
let SnowLoadsComponent = class SnowLoadsComponent {
    constructor() {
...
class AdditionForCalculations {
    constructor(addition) {
        this.origin = addition;
    }
}
AdditionForCalculations.ctorParameters = () => [
    { type: undefined }
];
...
class MaterialForCalculations {
    constructor(categoryName, material) {
        this.additions = [];
        this.categoryName = categoryName;
        this.material = material;
        this.unit = this.material.unit;
        this.material.additions.forEach(a => this.additions.push(new _addition_for_calculations__WEBPACK_IMPORTED_MODULE_0__["AdditionForCalculations"](a)));
    }
    calculate() {
        let length = 1;
        let width = 1;
...
MaterialForCalculations.ctorParameters = () => [
    { type: String },
    { type: undefined }
];
...
let DeadLoadsService = class DeadLoadsService {
    constructor(http) {
        this.http = http;
    }
    getCategories() {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_material_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/select */ "./node_modules/@angular/material/esm2015/select.js");
...
/* harmony import */ var _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @angular/material/bottom-sheet */ "./node_modules/@angular/material/esm2015/bottom-sheet.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ParameterAutocompleteComponent = class ParameterAutocompleteComponent {
    constructor() {
    ...
    ngOnInit() {
        this.filteredValueOptions = this.valueOptionsForm.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(value => this._filter(value)));
    }
    _filter(value) {
        const filterValue = value.toLowerCase();
        return this.parameter.valueOptions.filter(option => option.value.toLowerCase().indexOf(filterValue) === 0);
    }
    changeValue() {
...
let FiguresButtonComponent = class FiguresButtonComponent {
    constructor(dialog) {
        this.dialog = dialog;
    }
    openFigures() {
        ...
        const dialogRef = this.dialog.open(_figures_parameter_figures_component__WEBPACK_IMPORTED_MODULE_2__["ParameterFiguresComponent"], dialogConfig);
        dialogRef.afterClosed().subscribe(result => {
        });
    }
};
FiguresButtonComponent.ctorParameters = () => [
...
let ParameterFiguresComponent = class ParameterFiguresComponent {
    constructor(dialogRef, parameter) {
...
ParameterFiguresComponent.ctorParameters = () => [
...
let ParameterInputComponent = class ParameterInputComponent {
    constructor() {
        this.parameter = null;
        this.valueChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.parameterOptions = _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_1__["ParameterOptions"];
...
let ParameterFormComponent = class ParameterFormComponent {
    constructor() {
...
let ParameterRadioComponent = class ParameterRadioComponent {
    constructor() {
        this.parameter = null;
        this.valueChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.parameterOptions = _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_1__["ParameterOptions"];
...
let ParameterSelectComponent = class ParameterSelectComponent {
    constructor() {
        this.parameter = null;
        this.valueChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.parameterOptions = _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_1__["ParameterOptions"];
...
let ParameterResultComponent = class ParameterResultComponent {
    constructor() {
        this.parameter = null;
        //valueClass: string;
        //forbiddenSigns = ['(', ')', ',', '.', '^'];
...
let ScriptCalculatorComponent = class ScriptCalculatorComponent {
    constructor(route, scriptService, parameterService, calculationService, translationService) {
        this.route = route;
        this.scriptService = scriptService;
        this.parameterService = parameterService;
    ...
    setParameters() {
        this.parameterService.getParameters(this.script.id).subscribe(parameters => {
            this.parameters = parameters.filter(p => (p.context & _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_3__["ParameterOptions"].editable) != 0),
                this.staticDataParameters = parameters.filter(p => (p.context & _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_3__["ParameterOptions"].staticData) != 0 &&
    ...
    sortParameters(parameters, prop) {
        if (parameters)
            return parameters.sort((a, b) => a[prop] > b[prop] ? 1 :
                a[prop] === b[prop] ? 0 :
                    -1);
    }
    onValueChanged(parameter) {
    ...
    filterParameters() {
        this.visibleParameters = this.parameters.filter(p => (p.context & _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_3__["ParameterOptions"].visible) != 0 &&
    ...
    createGroups() {
        ...
        this.groups = groupNames.map(gn => new _models_parametersGroup__WEBPACK_IMPORTED_MODULE_5__["ParametersGroup"](gn));
    }
    populateGroups() {
    ...
    isValid() {
        let visibleParameters = this.parameters
            .filter(p => (p.context & _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_3__["ParameterOptions"].editable) != 0 &&
    ...
    calculate() {
        ...
        this.calculationService.calculate(this.script.id, this.parameters.filter(p => this.validateVisibility(p)))
            .subscribe(params => {
            this.resultParameters = params.filter(p => (p.context & _models_enums_parameterOptions__WEBPACK_IMPORTED_MODULE_3__["ParameterOptions"].visible) != 0);
    ...
    validateVisibility(parameter) {
        if (!parameter.visibilityValidator)
            return true;
        let visibilityValidatorEquation = parameter.visibilityValidator;
        this.parameters.forEach(p => {
            let value = p.valueType == _models_enums_valueType__WEBPACK_IMPORTED_MODULE_4__["ValueType"].number ? p.value : `'${p.value}'`;
            visibilityValidatorEquation = visibilityValidatorEquation.split(`[${p.name}]`).join(value);
        });
        try {
            let result = eval(visibilityValidatorEquation);
    ...
    validateData(parameter) {
        ...
        try {
            let result = eval(dataValidatorEquation);
            if (result != null)
                return result;
            else
                return true;
    ...
    setErrorMessages(visibleParameters) {
        this.errorMessages = [];
...
ScriptCalculatorComponent.ctorParameters = () => [
...
let ScriptCardComponent = class ScriptCardComponent {
    constructor(scriptService, auth) {
        this.scriptService = scriptService;
        this.auth = auth;
...
ScriptCardComponent.ctorParameters = () => [
...
let ScriptCardsComponent = class ScriptCardsComponent {
    constructor(scriptService, translationService, localStorage, searchService) {
        this.scriptService = scriptService;
        this.translationService = translationService;
    ...
    setScripts(lang) {
        this.scriptService.getScripts(lang).subscribe((scripts) => {
    ...
    setFilteredScripts() {
        ...
        if (this.filterValue)
            this.filteredScripts = this.filteredScripts.filter(s => s.name && s.name.toLowerCase().indexOf(this.filterValue.toLowerCase()) >= 0 ||
    ...
    onPageChanged(e) {
        setTimeout(() => {
            this.localStorage.savePermanentData(e.pageSize, _services_db_keys__WEBPACK_IMPORTED_MODULE_4__["DBkeys"].PAGESIZE);
            this.localStorage.savePermanentData(e.pageIndex, _services_db_keys__WEBPACK_IMPORTED_MODULE_4__["DBkeys"].PAGEINDEX);
        });
        this.setPage(e);
    }
    setPage(e) {
...
ScriptCardsComponent.ctorParameters = () => [
    { type: _services_script_service__WEBPACK_IMPORTED_MODULE_1__["ScriptService"] },
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/checkbox */ "./node_modules/@angular/material/esm2015/checkbox.js");
/* harmony import */ var _angular_material_radio__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material/radio */ "./node_modules/@angular/material/esm2015/radio.js");
...
let DataParameterFormComponent = class DataParameterFormComponent {
    ...
    get parameterVisibilityValidator() {
        return this.parameterForm.get('visibilityValidator');
    }
    get parameterDataValidator() {
    ...
    ngOnChanges(changes) {
        if (changes.newParameter) {
            let parameter = changes.newParameter.currentValue;
            this.parameterForm.patchValue(parameter);
            parameter.valueOptions.forEach(vo => this.parameterValueOptions.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            ...
            parameter.figures.forEach(f => this.parameterFigures.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
    ...
    setNewParameterChanges(newParameter) {
    ...
    setParameterType() {
        let value = this.parameterContext.value;
    ...
    addValueOption() {
        let valueOption = new _models_valueOptionImpl__WEBPACK_IMPORTED_MODULE_9__["ValueOptionImpl"]();
    ...
    select(parameter) {
        ...
        if (position >= 0) {
            let value = this.parameterValue.value;
...
DataParameterFormComponent.ctorParameters = () => [
...
let ExistingFiguresDialogComponent = class ExistingFiguresDialogComponent {
    constructor(dialogRef, figure, figureService) {
        this.dialogRef = dialogRef;
        this.figure = figure;
...
ExistingFiguresDialogComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"],] }] },
...
let FigureParameterFormComponent = class FigureParameterFormComponent {
    constructor(figureService, dialog) {
        this.figureService = figureService;
        this.dialog = dialog;
    }
    get parameterId() {
...
FigureParameterFormComponent.ctorParameters = () => [
...
let ValueOptionsFormComponent = class ValueOptionsFormComponent {
    constructor() {
    ...
    booleanSettingChecked(checkbox) {
...
let ParametersFormComponent = class ParametersFormComponent {
    constructor(parameterService, route) {
        this.parameterService = parameterService;
        this.route = route;
    ...
    getAddition() {
        ...
        if (this.parametersToShow == 'static' || this.parametersToShow == 'calculation') {
            let parametersFilterCriteria = _models_enums_parameter_filter__WEBPACK_IMPORTED_MODULE_2__["ParameterFilter"]['data'];
            addition += this.parameters.filter(p => (p.context & parametersFilterCriteria) != 0).length;
        }
        if (this.parametersToShow == 'calculation') {
            let parametersFilterCriteria = _models_enums_parameter_filter__WEBPACK_IMPORTED_MODULE_2__["ParameterFilter"]['static'];
            addition += this.parameters.filter(p => (p.context & parametersFilterCriteria) != 0).length;
        }
        return addition;
    }
    ...
    onParametersToShowChange() {
        let parametersFilterCriteria = _models_enums_parameter_filter__WEBPACK_IMPORTED_MODULE_2__["ParameterFilter"][this.parametersToShow];
...
ParametersFormComponent.ctorParameters = () => [
...
let ScriptDataFormComponent = class ScriptDataFormComponent {
    constructor() {
...
let ScriptFormComponent = class ScriptFormComponent {
    constructor(scriptService, tagService, route, router) {
        this.scriptService = scriptService;
    ...
    getScript(id) {
        this.scriptService.getScript(id, "en").subscribe(script => {
            ...
            script.tags.forEach(t => this.scriptTags.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
    ...
    _setTags() {
        return __awaiter(this, void 0, void 0, function* () {
            for (let tag of this.scriptTags.value)
                if (tag.id == 0) {
                    let newTag = yield this._setTag(tag);
                    tag.id = newTag.id;
                }
        });
    }
    _setTag(tag) {
        return __awaiter(this, void 0, void 0, function* () {
            var newTag = yield this.tagService.create(tag).toPromise();
            return newTag;
        });
    }
};
ScriptFormComponent.ctorParameters = () => [
...
let TagFormComponent = class TagFormComponent {
    ...
    ngOnInit() {
        this.filteredTags = this.tagCtrl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((tagName) => tagName ? this._filter(tagName) : this.tags));
        this.getTags();
    }
    getTags() {
        ...
        if (!this.matAutocomplete.isOpen) {
            ...
            if ((value || '').trim() && !this.scriptTags.controls.some(c => c.value.name == value.trim())) {
                this.scriptTags.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                    ...
                    name: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](value.trim())
                }));
            }
            if (input) {
                input.value = '';
...
TagFormComponent.ctorParameters = () => [
...
let ParameterTranslationFormComponent = class ParameterTranslationFormComponent {
    constructor(parameterTranslationService, valueOptionTranslationService, parameterService) {
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])([parameters$, parametersTranslations$]).subscribe(results => {
            this.parameters = results[0];
            results[1].forEach(pt => this.parametersTranslationsForm.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
    ...
    setMappedParameters() {
        this.mappedParameters = [];
        let parametersTranslation = this.parametersTranslationsForm.value;
        this.parameters.forEach(p => {
            let mappedParameter = {
                parameter: p, translation: parametersTranslation.find(pt => pt.parameterId == p.id) ||
                    new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                        ...
                        notes: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
                        groupName: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
                        language: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.translationLanguage.value)
                    }).value,
                valueOptions: []
            };
    ...
    setValueOptions() {
        this.mappedParameters.forEach(mp => {
            this.valueOptionTranslationService.getValueOptionsTranslations(mp.parameter.id, this.translationLanguage.value)
                .subscribe((vot) => {
                mp.parameter.valueOptions.forEach((vo) => {
                    mp.valueOptions.push({
                        origin: vo, translation: vot.find(v => v.valueOptionId == vo.id) || new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                            id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](0),
    ...
    updateValueOptionTranslation(valueOptionTranslation) {
        this.valueOptionTranslationService.update(valueOptionTranslation)
            .subscribe(vot => { });
    }
    createValueOptionTranslation(valueOptionTranslation) {
        this.valueOptionTranslationService.create(valueOptionTranslation)
            .subscribe(vot => { });
    }
    updateParameterTranslation(parameterTranslation) {
        this.parameterTranslationService.update(parameterTranslation)
            ...
            this.parametersTranslationsForm.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
    ...
    createParameterTranslation(parameterTranslation) {
...
ParameterTranslationFormComponent.ctorParameters = () => [
...
let ScriptTranslationFormComponent = class ScriptTranslationFormComponent {
    constructor(scriptTranslationService, route) {
    ...
    get originalDefaultLanguage() {
        return this.scriptForm.get('defaultLanguage');
    }
    get translationId() {
        return this.translationForm.get('id');
    }
    get translationScriptId() {
...
ScriptTranslationFormComponent.ctorParameters = () => [
...
let TranslationFormComponent = class TranslationFormComponent {
    constructor(scriptTranslationService, route) {
        this.scriptTranslationService = scriptTranslationService;
        this.route = route;
    ...
    onScriptTranslationSubmit() {
        if (!this.translationData.editMode) {
            ...
            this.scriptTranslationService.update(this.translationForm.value)
                .subscribe((scriptTranslation) => this.translationForm.patchValue(scriptTranslation));
            this.parameterTranslationForm.parametersSubmit();
        }
    }
...
TranslationFormComponent.ctorParameters = () => [
...
ParametersGroup.ctorParameters = () => [
    { type: String }
];
...
let ScriptInterpreterRoutingModule = class ScriptInterpreterRoutingModule {
};
...
let ScriptInterpreterModule = class ScriptInterpreterModule {
};
...
let CalculationService = class CalculationService {
    ...
    calculate(scriptId, parameters, language) {
...
let ParameterTranslationService = class ParameterTranslationService {
    constructor(http) {
        this.http = http;
    }
    getParametersTranslation(scriptId, language) {
...
ParameterTranslationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }
];
...
let ScriptTranslationService = class ScriptTranslationService {
    constructor(http) {
        this.http = http;
    }
    getScriptTranslation(scriptId, language) {
...
ScriptTranslationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }
];
...
let ValueOptionTranslationService = class ValueOptionTranslationService {
    constructor(http) {
        this.http = http;
    }
    getValueOptionsTranslations(parameterId, language) {
...
ValueOptionTranslationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }
];
        ...
        if (err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
            if (err.status === 401) {
                ...
                return this.auth.refreshToken()
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["flatMap"])((refreshed) => {
                    var token = (this.auth.isLoggedIn()) ? this.auth.getAuth().token : null;
                    if (token) {
...
AuthResponseInterceptor.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"] },
...
let LocalStoreManager = LocalStoreManager_1 = 
/**
...
class LocalStoreManager {
    ...
    getSyncKeysFromStorage(defaultValue = []) {
        const data = this.localStorageGetItem(LocalStoreManager_1.DBKEY_SYNC_KEYS);
        if (data == null)
            return defaultValue;
        else
            return data;
