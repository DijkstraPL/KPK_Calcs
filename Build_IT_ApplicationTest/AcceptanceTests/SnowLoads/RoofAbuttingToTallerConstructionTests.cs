...
namespace Build_IT_ApplicationTest.AcceptanceTests.SnowLoads
{
    ...
    public class RoofAbuttingToTallerConstructionTests
    {
        ...
        public void CalculateTests_RandomExamples_Success()
        {
            ...
            parametersForCalculation["b_1_"].Value = _testEngine.GetSmallRandom();
            parametersForCalculation["b_2_"].Value = _testEngine.GetSmallRandom();
            parametersForCalculation["h"].Value = _testEngine.GetSmallRandom();
