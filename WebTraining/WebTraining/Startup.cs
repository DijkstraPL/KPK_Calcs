...
using WebTraining.Authorization;
using WebTraining.Helpers;
using WebTraining.ViewModels;
...
namespace WebTraining
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("WebTraining"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "WebTraining API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ILogger<Startup> logger, IDatabaseInitializer databaseInitializer)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebTraining API V1");
            });
